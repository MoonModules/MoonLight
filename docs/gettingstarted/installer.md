...
See [Hardware](hardware.md) for other options.
...
| [esp32-d0-pico2](https://documentation.espressif.com/esp32-pico-mini-02_datasheet_en.pdf) | ![esp32-d0-pico2](../firmware/installer/images/esp32-d0-pico2.jpg){: style="width:100px"} | <esp-web-install-button manifest="https://moonmodules.org/MoonLight/firmware/installer/manifest_esp32-d0-pico2.json"></esp-web-install-button> | <esp-web-install-button manifest="https://moonmodules.org/MoonLight/firmware/installer/manifest_esp32-d0-pico2-nightly.json"></esp-web-install-button> | [Dig-Next-2](../moonbase/inputoutput.md#dig-next-2):<br>![Dig-Next-2](https://quinled.info/wp-content/uploads/2026/01/P1087754-Enhanced-NR-2560x1358.jpg){: style="width:100px"}<br>[MHC V57 PRO](../moonbase/inputoutput.md#mhc-v57-pro):<br>![MHC V57 PRO](https://shop.myhome-control.de/media/09/90/ff/1771179461/WLED_V57_Bild1a.jpg){: style="width:100px"}|
| esp32-p4-nano | ![esp32-p4-nano](../firmware/installer/images/esp32-p4-nano.jpg){: style="width:100px"} | First Install<br> [esp32-c6-firmware-update](https://esp32-c6-firmware-update.github.io)<br><esp-web-install-button manifest="https://moonmodules.org/MoonLight/firmware/installer/manifest_esp32-p4-nano.json"></esp-web-install-button> | <esp-web-install-button manifest="https://moonmodules.org/MoonLight/firmware/installer/manifest_esp32-p4-nano-nightly.json"></esp-web-install-button> | [Waveshare](https://www.waveshare.com/esp32-p4-nano.htm){:target="_blank"}<br>[MHC ESP32-P4 shield](../moonbase/inputoutput.md#mhc-esp32-p4-shield):<br>![MHC ESP32-P4 shield](../moonbase/MHC-ESP32-P4-shield.png){: style="width:100px"} |
| esp32-s3-n8r8v | ![esp32-s3-n8r8v](../firmware/installer/images/esp32-s3-n8r8v.jpg){: style="width:100px"} | <esp-web-install-button manifest="https://moonmodules.org/MoonLight/firmware/installer/manifest_esp32-s3-n8r8v.json"></esp-web-install-button> | <esp-web-install-button manifest="https://moonmodules.org/MoonLight/firmware/installer/manifest_esp32-s3-n8r8v-nightly.json">Nightly</esp-web-install-button> | [SE-16p](../moonbase/inputoutput.md#se16-v1)<br>![SE-16p](../firmware/installer/images/esp32-s3-stephanelec-16p.jpg){: style="width:100px"}<br>[LightCrafter16](../moonbase/inputoutput.md#lightcrafter16)<br>![LightCrafter16](../firmware/installer/images/esp32-s3-lightcrafter16.jpg){: style="width:100px"} |
...
Add a [WiFi](../network/sta.md) connection.
...
Select your board in [Module IO](../moonbase/inputoutput.md).
...
The Effects module contains [Effects](../moonlight/effects.md) and [Modifiers](../moonlight/modifiers.md).
...
The preferred way to update MoonLight is directly within MoonLight via [System update](../system/update.md).
...
See [Develop / Installation](../develop/installation.md).
