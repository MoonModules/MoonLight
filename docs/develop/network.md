...
## ModuleDevices — UDP Protocol

See [develop/devices](https://moonmodules.org/MoonLight/develop/devices/) for the full reference, including packet formats, port architecture, WLED compatibility, and group sync behaviour.
