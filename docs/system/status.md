...
* 🌙 **Performance**: loops per second: for effects, for drivers and overall. 🆕 Effects and drivers is the theoritical speed, if nothing else runs. overall lps is the really measured overall speed.
