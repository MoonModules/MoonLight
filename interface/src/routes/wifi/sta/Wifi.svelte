...
<SettingsCard collapsible={false}>
	...
	<div class="flex justify-end px-4 pb-3">
		<a href="http://{page.url.host}/rest/wifiSettings" target="_blank" rel="noopener noreferrer" title="API: http://{page.url.host}/rest/wifiSettings"><Api class="mr-2 h-6 w-6 shrink-0 self-end" /></a>
	</div>
</SettingsCard>
