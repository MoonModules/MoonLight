...
const byte ib_jul01_gp[] = {0, 194, 1, 1, 94, 1, 29, 18, 132, 57, 131, 28, 255, 113, 1, 1};
...
const byte es_vintage_57_gp[] = {0, 2, 1, 1, 53, 18, 1, 0, 104, 69, 29, 1, 153, 167, 135, 10, 255, 46, 56, 4};
...
const byte es_vintage_01_gp[] = {0, 4, 1, 1, 51, 16, 0, 1, 76, 97, 104, 3, 101, 255, 131, 19, 127, 67, 9, 4, 153, 16, 0, 1, 229, 4, 1, 1, 255, 4, 1, 1};
...
const byte es_rivendell_15_gp[] = {0, 1, 14, 5, 101, 16, 36, 14, 165, 56, 68, 30, 242, 150, 156, 99, 255, 150, 156, 99};
...
const byte rgi_15_gp[] = {0, 4, 1, 70, 31, 55, 1, 30, 63, 255, 4, 7, 95, 59, 2, 29, 127, 11, 3, 50, 159, 39, 8, 60, 191, 112, 19, 40, 223, 78, 11, 39, 255, 29, 8, 59};
...
const byte retro2_16_gp[] = {0, 188, 135, 1, 255, 46, 7, 1};
...
const byte Analogous_1_gp[] = {0, 3, 0, 255, 63, 23, 0, 255, 127, 67, 0, 255, 191, 142, 0, 45, 255, 255, 0, 0};
...
const byte es_pinksplash_08_gp[] = {0, 126, 11, 255, 127, 197, 1, 22, 175, 210, 157, 172, 221, 157, 3, 112, 255, 157, 3, 112};
...
const byte es_ocean_breeze_036_gp[] = {0, 1, 6, 7, 89, 1, 99, 111, 153, 144, 209, 255, 255, 0, 73, 82};
...
const byte departure_gp[] = {0, 8, 3, 0, 42, 23, 7, 0, 63, 75, 38, 6, 84, 169, 99, 38, 106, 213, 169, 119, 116, 255, 255, 255, 138, 135, 255, 138, 148, 22, 255, 24, 170, 0, 255, 0, 191, 0, 136, 0, 212, 0, 55, 0, 255, 0, 55, 0};
...
const byte es_landscape_64_gp[] = {0, 0, 0, 0, 37, 2, 25, 1, 76, 15, 115, 5, 127, 79, 213, 1, 128, 126, 211, 47, 130, 188, 209, 247, 153, 144, 182, 205, 204, 59, 117, 250, 255, 1, 37, 192};
...
const byte es_landscape_33_gp[] = {0, 1, 5, 0, 19, 32, 23, 1, 38, 161, 55, 1, 63, 229, 144, 1, 66, 39, 142, 74, 255, 1, 4, 1};
...
const byte rainbowsherbet_gp[] = {0, 255, 33, 4, 43, 255, 68, 25, 86, 255, 7, 25, 127, 255, 82, 103, 170, 255, 255, 242, 209, 42, 255, 22, 255, 87, 255, 65};
...
const byte gr65_hult_gp[] = {0, 247, 176, 247, 48, 255, 136, 255, 89, 220, 29, 226, 160, 7, 82, 178, 216, 1, 124, 109, 255, 1, 124, 109};
...
const byte gr64_hult_gp[] = {0, 1, 124, 109, 66, 1, 93, 79, 104, 52, 65, 1, 130, 115, 127, 1, 150, 52, 65, 1, 201, 1, 86, 72, 239, 0, 55, 45, 255, 0, 55, 45};
...
const byte GMT_drywet_gp[] = {0, 47, 30, 2, 42, 213, 147, 24, 84, 103, 219, 52, 127, 3, 219, 207, 170, 1, 48, 214, 212, 1, 1, 111, 255, 1, 7, 33};
...
const byte ib15_gp[] = {0, 113, 91, 147, 72, 157, 88, 78, 89, 208, 85, 33, 107, 255, 29, 11, 141, 137, 31, 39, 255, 59, 33, 89};
...
const byte Tertiary_01_gp[] = {0, 0, 1, 255, 63, 3, 68, 45, 127, 23, 255, 0, 191, 100, 68, 1, 255, 255, 1, 4};
...
const byte lava_gp[] = {0, 0, 0, 0, 46, 18, 0, 0, 96, 113, 0, 0, 108, 142, 3, 1, 119, 175, 17, 1, 146, 213, 44, 2, 174, 255, 82, 4, 188, 255, 115, 4, 202, 255, 156, 4, 218, 255, 203, 4, 234, 255, 255, 4, 244, 255, 255, 71, 255, 255, 255, 255};
...
const byte fierce_ice_gp[] = {0, 0, 0, 0, 59, 0, 9, 45, 119, 0, 38, 255, 149, 3, 100, 255, 180, 23, 199, 255, 217, 100, 235, 255, 255, 255, 255, 255};
...
const byte Colorfull_gp[] = {0, 10, 85, 5, 25, 29, 109, 18, 60, 59, 138, 42, 93, 83, 99, 52, 106, 110, 66, 64, 109, 123, 49, 65, 113, 139, 35, 66, 116, 192, 117, 98, 124, 255, 255, 137, 168, 100, 180, 155, 255, 22, 121, 174};
...
const byte Pink_Purple_gp[] = {0, 19, 2, 39, 25, 26, 4, 45, 51, 33, 6, 52, 76, 68, 62, 125, 102, 118, 187, 240, 109, 163, 215, 247, 114, 217, 244, 255, 122, 159, 149, 221, 149, 113, 78, 188, 183, 128, 57, 155, 255, 146, 40, 123};
...
const byte Sunset_Real_gp[] = {0, 120, 0, 0, 22, 179, 22, 0, 51, 255, 104, 0, 85, 167, 22, 18, 135, 100, 0, 103, 198, 16, 0, 130, 255, 0, 0, 160};
...
const byte Sunset_Yellow_gp[] = {0, 10, 62, 123, 36, 56, 130, 103, 87, 153, 225, 85, 100, 199, 217, 68, 107, 255, 207, 54, 115, 247, 152, 57, 120, 239, 107, 61, 128, 247, 152, 57, 180, 255, 207, 54, 223, 255, 227, 48, 255, 255, 248, 42};
...
const byte Beech_gp[] = {0, 255, 252, 214, 12, 255, 252, 214, 22, 255, 252, 214, 26, 190, 191, 115, 28, 137, 141, 52, 28, 112, 255, 205, 50, 51, 246, 214, 71, 17, 235, 226, 93, 2, 193, 199, 120, 0, 156, 174, 133, 1, 101, 115, 136, 1, 59, 71, 136, 7, 131, 170, 208, 1, 90, 151, 255, 0, 56, 133};
...
const byte Another_Sunset_gp[] = {0, 110, 49, 11, 29, 55, 34, 10, 68, 22, 22, 9, 68, 239, 124, 8, 97, 220, 156, 27, 124, 203, 193, 61, 178, 33, 53, 56, 255, 0, 1, 52};
...
const byte es_autumn_19_gp[] = {0, 26, 1, 1, 51, 67, 4, 1, 84, 118, 14, 1, 104, 137, 152, 52, 112, 113, 65, 1, 122, 133, 149, 59, 124, 137, 152, 52, 135, 113, 65, 1, 142, 139, 154, 46, 163, 113, 13, 1, 204, 55, 3, 1, 249, 17, 1, 1, 255, 17, 1, 1};
...
const byte BlacK_Blue_Magenta_White_gp[] = {0, 0, 0, 0, 42, 0, 0, 45, 84, 0, 0, 255, 127, 42, 0, 255, 170, 255, 0, 255, 212, 255, 55, 255, 255, 255, 255, 255};
...
const byte BlacK_Magenta_Red_gp[] = {0, 0, 0, 0, 63, 42, 0, 45, 127, 255, 0, 255, 191, 255, 0, 45, 255, 255, 0, 0};
...
const byte BlacK_Red_Magenta_Yellow_gp[] = {0, 0, 0, 0, 42, 42, 0, 0, 84, 255, 0, 0, 127, 255, 0, 45, 170, 255, 0, 255, 212, 255, 55, 45, 255, 255, 255, 0};
...
const byte Blue_Cyan_Yellow_gp[] = {0, 0, 0, 255, 63, 0, 55, 255, 127, 0, 255, 255, 191, 42, 255, 45, 255, 255, 255, 0};
...
const byte Orangery_gp[] = {0, 255, 95, 23, 30, 255, 82, 0, 60, 223, 13, 8, 90, 144, 44, 2, 120, 255, 110, 17, 150, 255, 69, 0, 180, 158, 13, 11, 210, 241, 82, 17, 255, 213, 37, 4};
...
const byte temperature_gp[] = {0, 1, 27, 105, 14, 1, 40, 127, 28, 1, 70, 168, 42, 1, 92, 197, 56, 1, 119, 221, 70, 3, 130, 151, 84, 23, 156, 149, 99, 67, 182, 112, 113, 121, 201, 52, 127, 142, 203, 11, 141, 224, 223, 1, 155, 252, 187, 2, 170, 247, 147, 1, 184, 237, 87, 1, 198, 229, 43, 1, 226, 171, 2, 2, 240, 80, 3, 3, 255, 80, 3, 3};
...
const byte retro_clown_gp[] = {0, 227, 101, 3, 117, 194, 18, 19, 255, 92, 8, 192};
...
const byte candy_gp[] = {0, 229, 227, 1, 15, 227, 101, 3, 142, 40, 1, 80, 198, 17, 1, 79, 255, 0, 0, 45};
...
const byte toxy_reaf_gp[] = {0, 1, 221, 53, 255, 73, 3, 178};
...
const byte fairy_reaf_gp[] = {0, 184, 1, 128, 160, 1, 193, 182, 219, 153, 227, 190, 255, 255, 255, 255};
...
const byte semi_blue_gp[] = {0, 0, 0, 0, 12, 1, 1, 3, 53, 8, 1, 22, 80, 4, 6, 89, 119, 2, 25, 216, 145, 7, 10, 99, 186, 15, 2, 31, 233, 2, 1, 5, 255, 0, 0, 0};
...
const byte pink_candy_gp[] = {0, 255, 255, 255, 45, 7, 12, 255, 112, 227, 1, 127, 112, 227, 1, 127, 140, 255, 255, 255, 155, 227, 1, 127, 196, 45, 1, 99, 255, 255, 255, 255};
...
const byte red_reaf_gp[] = {0, 3, 13, 43, 104, 78, 141, 240, 188, 255, 0, 0, 255, 28, 1, 1};
...
const byte aqua_flash_gp[] = {0, 0, 0, 0, 66, 57, 227, 233, 96, 255, 255, 8, 124, 255, 255, 255, 153, 255, 255, 8, 188, 57, 227, 233, 255, 0, 0, 0};
...
const byte yelblu_hot_gp[] = {0, 4, 2, 9, 58, 16, 0, 47, 122, 24, 0, 16, 158, 144, 9, 1, 183, 179, 45, 1, 219, 220, 114, 2, 255, 234, 237, 1};
...
const byte lite_light_gp[] = {0, 0, 0, 0, 9, 1, 1, 1, 40, 5, 5, 6, 66, 5, 5, 6, 101, 10, 1, 12, 255, 0, 0, 0};
...
const byte red_flash_gp[] = {0, 0, 0, 0, 99, 227, 1, 1, 130, 249, 199, 95, 155, 227, 1, 1, 255, 0, 0, 0};
...
const byte blink_red_gp[] = {0, 1, 1, 1, 43, 4, 1, 11, 76, 10, 1, 3, 109, 161, 4, 29, 127, 255, 86, 123, 165, 125, 16, 160, 204, 35, 13, 223, 255, 18, 2, 18};
...
const byte red_shift_gp[] = {0, 31, 1, 27, 45, 34, 1, 16, 99, 137, 5, 9, 132, 213, 128, 10, 175, 199, 22, 1, 201, 199, 9, 6, 255, 1, 0, 1};
...
const byte red_tide_gp[] = {0, 247, 5, 0, 28, 255, 67, 1, 43, 234, 88, 11, 58, 234, 176, 51, 84, 229, 28, 1, 114, 113, 12, 1, 140, 255, 225, 44, 168, 113, 12, 1, 196, 244, 209, 88, 216, 255, 28, 1, 255, 53, 1, 1};
...
const byte candy2_gp[] = {0, 39, 33, 34, 25, 4, 6, 15, 48, 49, 29, 22, 73, 224, 173, 1, 89, 177, 35, 5, 130, 4, 6, 15, 163, 255, 114, 6, 186, 224, 173, 1, 211, 39, 33, 34, 255, 1, 1, 1};

// WLEDMM netmindz ar palette
// Start off as just RGB, but replace in runtime with colors relating to the music
const byte audio_responsive_gp[] = {0, 255, 0, 0, 125, 0, 255, 0, 255, 0, 0, 255};
